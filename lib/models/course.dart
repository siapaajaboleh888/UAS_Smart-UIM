  ...
  static List<Course> getSampleCourses() {
    return [
      Course(
        ...
        semester: '2024/2025',
        progress: 92,
        imageUrl: 'assets/images/pemrograman_mobile.jpg',
      ),
      Course(
        id: '2',
        name: 'DESAIN ANTARMUKA & PENGALAMAN PENGGUNA',
        code: 'TIF-2202 [MSA]',
        instructor: 'Aleandro Robery, S.T., M.T.',
        semester: '2024/2025',
        progress: 88,
        imageUrl: 'https://cdn-icons-png.flaticon.com/512/1260/1260111.png', // Logo UI/UX permanen
      ),
      Course(
        id: '3',
        name: 'SISTEM BASIS DATA',
        code: 'TIF-2203 [AHM]',
        instructor: 'Ahmad Mahfud, S.Kom., M.Cs.',
        semester: '2024/2025',
        progress: 90,
      ...
      Course(
        ...
        code: 'TIF-2205 [NUR]',
        instructor: 'Nur Hidayah, S.Kom., M.Kom.',
        semester: '2024/2025',
        progress: 91,
      ...
      Course(
        ...
        code: 'TIF-2207 [ZIN]',
        instructor: 'Zainuddin, S.Kom., M.T.',
        semester: '2024/2025',
        progress: 89,
