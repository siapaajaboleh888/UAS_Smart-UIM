    ...
    return {
      '1': CourseDetailData(
        materials: [
          ...
          CourseContent(
            id: 'm2', 
            title: 'Instalasi Flutter & Dart SDK', 
            info: '1 Video, 2 Panduan Instalasi', 
            description: 'Panduan lengkap cara menginstal Flutter SDK dan Dart di berbagai sistem operasi serta melakukan konfigurasi path.',
            isCompleted: true, 
            type: ContentType.material, 
            week: 2,
            subItems: [
              MeetingSubItem(title: 'Video Tutorial Instalasi', icon: Icons.play_circle_fill, isCompleted: true),
              MeetingSubItem(title: 'Instalasi di Windows', icon: Icons.description, isCompleted: true),
              MeetingSubItem(title: 'Instalasi di macOS', icon: Icons.description, isCompleted: false),
            ],
          ),
          CourseContent(
            id: 'm3', 
            title: 'Stateless vs Stateful Widget', 
            info: '1 Video, 3 Latihan Code', 
            description: 'Memahami perbedaan mendasar antara Stateless dan Stateful widget serta kapan waktu yang tepat untuk menggunakannya.',
            isCompleted: true, 
            type: ContentType.material, 
            week: 3,
            subItems: [
              MeetingSubItem(title: 'Video Penjelasan State', icon: Icons.play_circle_fill, isCompleted: true),
              MeetingSubItem(title: 'Latihan 1: Stateless Widget', icon: Icons.code, isCompleted: true),
              MeetingSubItem(title: 'Latihan 2: Counter App', icon: Icons.code, isCompleted: true),
              MeetingSubItem(title: 'Latihan 3: Lifecycle Widget', icon: Icons.code, isCompleted: false),
            ],
          ),
          CourseContent(
            id: 'm4', 
            title: 'Layouting & Basic Widgets', 
            info: '2 Video, 4 Latihan Code', 
            description: 'Mempelajari cara menyusun tata letak aplikasi menggunakan Container, Row, Column, dan berbagai widget dasar lainnya.',
            isCompleted: true, 
            type: ContentType.material, 
            week: 4,
            subItems: [
              MeetingSubItem(title: 'Video Layouting Dasar', icon: Icons.play_circle_fill, isCompleted: true),
              MeetingSubItem(title: 'Video Advanced Layout', icon: Icons.play_circle_fill, isCompleted: true),
              MeetingSubItem(title: 'Latihan: Personal Profile UI', icon: Icons.code, isCompleted: true),
              MeetingSubItem(title: 'Latihan: Login Screen UI', icon: Icons.code, isCompleted: true),
            ],
          ),
          CourseContent(
            id: 'm5', 
            title: 'Navigation & Routing', 
            info: '1 Video, 2 Latihan Code', 
            description: 'Implementasi perpindahan antar layar (screen) dan pengiriman data menggunakan Navigator dan Named Routes.',
            isCompleted: true, 
            type: ContentType.material, 
            week: 5,
            subItems: [
              MeetingSubItem(title: 'Video Navigation Guide', icon: Icons.play_circle_fill, isCompleted: true),
              MeetingSubItem(title: 'Latihan: Multi-screen App', icon: Icons.code, isCompleted: true),
              MeetingSubItem(title: 'Latihan: Passing Data', icon: Icons.code, isCompleted: false),
            ],
          ),
        ],
        tasks: [
          CourseContent(
            ...
            info: 'KUIS', 
            deadline: '25 Desember 2025 23:59 WIB', 
            isCompleted: true, 
            type: ContentType.task, 
            week: 1,
            description: 'Kuis evaluasi pertemuan pertama mengenai dasar-dasar pemrograman mobile dan sejarah perkembangannya.',
          ),
          CourseContent(
            id: 't2', 
            title: 'Tugas 01 - Instalasi SDK', 
            info: 'TUGAS', 
            deadline: '28 Desember 2025 23:59 WIB', 
            isCompleted: false, 
            type: ContentType.task, 
            week: 2,
            description: '1. Unduh dan Instal Flutter SDK versi terbaru.\n2. Konfigurasi Environment Variable pada sistem operasi Anda.\n3. Instal extension Flutter & Dart di VS Code.\n4. Jalankan perintah "flutter doctor" di terminal.\n5. Screenshot hasil flutter doctor dan simpan dalam PDF.',
          ),
          CourseContent(
            id: 't3', 
            title: 'Kuis - Assessment 2', 
            info: 'Pertemuan 3', 
            deadline: '30 Desember 2025 23:59 WIB', 
            isCompleted: true, 
            type: ContentType.task, 
            week: 3,
            description: 'Kuis mengenai perbedaan Stateless dan Stateful Widget serta siklus hidupnya.',
          ),
        ],
      ),
      '2': CourseDetailData(
        ...
        tasks: [
          CourseContent(
            ...
            type: ContentType.task, 
            week: 1,
            description: 'Kuis pemahaman materi dasar User Interface Design.',
          ),
          CourseContent(
            id: 't2', 
            title: 'Tugas 01 - UID Android Mobile Game', 
            ...
            type: ContentType.task, 
            week: 2,
            description: '1. Buatlah desain wireframe untuk aplikasi mobile game FPS.\n2. Desain harus mencakup Menu Utama, In-game UI, dan Settings.\n3. Berikan penjelasan pada setiap elemen desain.\n4. Kumpulkan file dalam format PDF maksimal 5MB.',
          ),
          CourseContent(
            id: 't3', 
            ...
            type: ContentType.task, 
            week: 6,
            description: 'Evaluasi tengah semester mencakup seluruh materi UID dari pertemuan 1-5.',
          ),
          CourseContent(
            id: 't4', 
            title: 'Tugas Observasi Etnografi', 
            info: 'TUGAS', 
            deadline: '10 Januari 2026 23:59 WIB', 
            isCompleted: false, 
            type: ContentType.task, 
            week: 4,
            description: '1. Lakukan observasi pada target pengguna aplikasi tertentu.\n2. Catat pain points dan kebutuhan mereka.\n3. Jabarkan temuan dalam bentuk laporan tertulis (PDF).',
          ),
        ],
      ),
      '3': CourseDetailData(
